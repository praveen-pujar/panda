          ...
          <div class="card">
            ...
            <div class="card-body tab-content">
              <div class="tab-pane active" id="profile">
                ...
                <img src={require("../img/panda_logo.png")} alt="user" class="d-block ui-w-80" width="150px" />
                <div class="media-body ml-4">
                  <label class="">
                    Upload new photo
                    <input type="file" style={{cursor:"pointer"}} class="account-settings-fileinput" name="profileImage" />
                  </label> &nbsp;
                  <button type="button" class="btn btn-default btn btn-outline-primary md-btn-flat">Reset</button>
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control"  name="firstname"  id="firstname" aria-describedby="fullNameHelp" placeholder="Enter your first name" value="" />
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="lastname" id="lastname" aria-describedby="fullNameHelp" placeholder="Enter your last name" value="" />
                    <small id="fullNameHelp" class="form-text text-muted">Your name may appear around here where you are mentioned. You can change or remove it at any time.</small>
                  </div>
                  <div class="form-group">
                    <label for="bio">Your Bio</label>
                    <textarea class="form-control autosize" id="bio" placeholder="Write something about you..." style={{overflow: "hidden", overflowWrap: "break-word", resize: "none", height: "62px"}} >
